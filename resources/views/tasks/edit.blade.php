        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="description" placeholder="Detail">{{$task->description}}</textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="status">
                        @foreach (App\Models\Task::STATUSES as $status)
                            @if (auth()->user()->hasRole('employee') && ($status !== 'Closed'))
